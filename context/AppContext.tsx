...
interface AppContextType {
  ...
  deleteReports: () => void;
  prices: Prices;
  updatePrices: (newPrices: Prices) => void;
  page: Page;
...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const addDevice = () => {
    setDevices(prev => {
      ...
      return [...prev, { id: newId, name: `PS-${newId}`, status: DeviceStatus.Available, type: DeviceType.PS4 }];
    });
  };
  ...
  const updatePrices = (newPrices: Prices) => setPrices(newPrices);
